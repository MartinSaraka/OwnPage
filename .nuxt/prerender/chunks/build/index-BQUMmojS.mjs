...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrGetDirectiveProps } from 'file://C:/Users/Martin/Downloads/personal_website_rev2/personal_website/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="hero" data-v-c70f2ff3><div class="hero-content" data-v-c70f2ff3><div class="hero-icons" data-v-c70f2ff3><span class="knight-icon" data-v-c70f2ff3>\u2694\uFE0F</span><span class="laptop-icon" data-v-c70f2ff3> \u{1F4BB} `);
      _push(ssrRenderComponent(_component_WelcomeBird, null, null, _parent));
      _push(`</span></div><h1 data-v-c70f2ff3><span class="name-text" data-v-c70f2ff3>Martin Saraka</span><span class="title-subtitle" data-v-c70f2ff3>Elite Full-Stack Developer</span></h1><p class="hero-description" data-v-c70f2ff3> Full\u2011stack developer passionate about building scalable and intuitive web applications with <span class="highlight" data-v-c70f2ff3>enterprise-grade precision</span> and <span class="highlight" data-v-c70f2ff3>cutting-edge technology</span>. </p><div class="hero-actions" data-v-c70f2ff3><a href="#contact" class="cta primary" data-v-c70f2ff3>Get in touch</a><a href="javascript:void(0)" class="cta secondary" data-v-c70f2ff3>View Portfolio</a></div><div class="badge" data-v-c70f2ff3><span class="dot" data-v-c70f2ff3></span> Premium Full\u2011Stack Expert <span class="shield-icon" data-v-c70f2ff3>\u2B50</span></div><div class="hero-stats" data-v-c70f2ff3><div class="stat" data-v-c70f2ff3><span class="stat-icon" data-v-c70f2ff3>\u26A1</span><strong data-v-c70f2ff3>5+</strong><span data-v-c70f2ff3>years exp.</span></div><div class="stat productivity-stat" data-v-c70f2ff3><span class="stat-icon" style="${ssrRenderStyle({ "opacity": "0" })}" data-v-c70f2ff3>\u{1F680}</span><strong data-v-c70f2ff3>10\xD7</strong><span data-v-c70f2ff3>productivity</span>`);
      _push(ssrRenderComponent(_component_OrbitingRocket, null, null, _parent));
      _push(`</div><div class="stat" data-v-c70f2ff3><span class="stat-icon" data-v-c70f2ff3>\u{1F3C6}</span><strong data-v-c70f2ff3>20+</strong><span data-v-c70f2ff3>projects</span></div></div></div><span class="orb orb-a" aria-hidden="true" data-v-c70f2ff3></span><span class="orb orb-b" aria-hidden="true" data-v-c70f2ff3></span><span class="orb orb-c" aria-hidden="true" data-v-c70f2ff3></span></section>`);
...
//# sourceMappingURL=index-BQUMmojS.mjs.map
